...
object Config {
  ...
  case class TiniConfig(apiKey: String, envExample: String, discordBotToken: String, killSecret: String, kafka: Kafka)
  case class Kafka(server: String, port: Short, topic: String, shemaURI: String)
